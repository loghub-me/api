...
(
    ...
    normalized_content  text         NOT NULL,            -- for search
    ...
    writer_username     varchar(12)  NOT NULL,            -- for search
...
(
    ...
    stargazer_id bigint                NOT NULL
        CONSTRAINT user_stars_stargazer_id_fk REFERENCES public.users ON DELETE CASCADE
);
...
(
    ...
    recipient_id   bigint       NOT NULL
        CONSTRAINT notifications_recipient_id_fk REFERENCES public.users ON DELETE CASCADE
);
