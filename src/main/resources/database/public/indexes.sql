...
CREATE INDEX IF NOT EXISTS articles_writer_username_trending_score_idx ON public.articles (writer_username, trending_score DESC);
...
CREATE INDEX IF NOT EXISTS series_writer_username_trending_score_idx ON public.series (writer_username, trending_score DESC);
...
CREATE INDEX IF NOT EXISTS questions_status_trending_idx ON public.questions (status, trending_score DESC);
...
CREATE INDEX IF NOT EXISTS questions_writer_username_status_trending_score_idx ON public.questions (writer_username, status, trending_score DESC);
