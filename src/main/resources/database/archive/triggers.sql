...
CREATE TRIGGER trg_archive_series_chapter_on_delete
    AFTER DELETE
    ON public.series_chapters
    FOR EACH ROW
EXECUTE FUNCTION archive.archive_series_chapter_on_delete();
...
CREATE TRIGGER trg_archive_question_answer_on_delete
    ...
    FOR EACH ROW
EXECUTE FUNCTION archive.archive_question_answer_on_delete();
